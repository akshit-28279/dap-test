...
8. It does not set Access-Control-Allow-Origin header
...
local aerospike_auth_lua_file = assert(loadfile("/etc/nginx/lua/auth/aerospike_auth_userInfo_education_form.lua"))
